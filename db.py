...
if __name__ == "__main__":
    db = Database('''CREATE TABLE IF NOT EXISTS books (ind INTEGER PRIMARY KEY ASC, name TEXT, page INTEGET,path TEXT)''')
    db.execute()
    add = QuerySequencer('INSERT INTO books VALUES (?,?,?,?)')
    books = [(None,'test',12,'reelpath'),(None,'test2',123,'reelpath2'),(None,'test3',124,'reelpath3'),(None,'test4',125,'reelpath4')]
    add.execute(books)
